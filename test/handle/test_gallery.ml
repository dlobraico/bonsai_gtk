    ...
    ((kind Windows) (attrs ())
     (children
      (List
       (((kind
          (Window
           ((title (about)) (transient_for (main)) (modal true)
            (resizable false))))
         (key about) (attrs ((On_close_request <handler>)))
         (children
          (Single
           (((kind (Label ((text "a transient dialog")))) (attrs ())
             (children No_children))))))
        ((kind (Window ((title ("every widget")) (default_size ((900 560))))))
         (key main) (attrs ((Widget_name every-widget-root)))
         (children
          (Single
           (((kind (Box ((orientation Horizontal))))
             ...
             (children
              (List
               (((kind (Stack_sidebar ((stack all))))
                 (attrs ((Width_request 140))) (children No_children))
                ((kind (Separator ((orientation Vertical)))) (attrs ())
                 (children No_children))
                ((kind (Box ((orientation Vertical)))) (attrs ((Hexpand true)))
                 (children
                  (List
                   (((kind (Stack_switcher ((stack all))))
                     (attrs ((Halign Center))) (children No_children))
                    ((kind
                      (Stack
                       ((name all) (visible_child leaves) (transition Crossfade))))
                     (attrs
                      ((Vexpand true) (On_visible_child_changed <handler>)))
                     (children
                      (List
                       (((kind (Box ((orientation Vertical) (spacing 8))))
                         ...
                         (children
                          (List
                           (((kind
                              (Label
                               ((text label) (wrap true) (xalign 0)
                                (ellipsize (End)) (max_width_chars 14)
                                (width_chars 10) (selectable true)
                                (use_markup true))))
                             ...
                             (children
                              (Single
                               (((kind (Label ((text child)))) (attrs ())
                                 (children No_children))))))
                            ((kind
                              (Toggle_button ((label (toggle)) (active true))))
                             (attrs ((On_toggled <handler>)))
                             (children (Single ())))
                            ((kind
                              (Check_button
                               ((label (check)) (active false)
                                (inconsistent true))))
                             (attrs ((On_toggled <handler>)))
                             (children No_children))
                            ...
                            ((kind
                             ...
                             (attrs ()) (children No_children))
                            ((kind
                              (Search_entry ((text "") (search_delay (200)))))
                            ...
                            ((kind
                              (Spin_button
                               ((value 0) (min 0) (max 10) (digits 2))))
                             (attrs ((On_value_changed <handler>)))
                             (children No_children))
                            ((kind
                              (Scale
                               ((orientation Horizontal) (value 0) (min 0)
                                (max 10))))
                             (attrs ((On_value_changed <handler>)))
                             (children No_children))
                            ((kind
                              (Progress_bar ((fraction 0.5) (show_text true))))
                             (attrs ()) (children No_children))
                            ((kind
                              (Drop_down
                               ((items (one two)) (selected 1)
                                (enable_search true))))
                             (attrs ((On_selected_changed <handler>)))
                             (children No_children))
                            ((kind
                              (Level_bar ((value 3) (max 5) (mode Discrete))))
                             (attrs ()) (children No_children))
                            ((kind
                              (Calendar
                            ...
                            ((kind
                              (Picture
                               ((source Empty) (alternative_text (nothing)))))
                             (attrs ()) (children No_children))
                             ...
                             (children
                              (Single
                               (((kind (Label ((text framed)))) (attrs ())
                                 (children No_children))))))
                            ((kind
                              (Expander ((label (expander)) (expanded false))))
                                ...
                                (rows
                                 (List
                                  (((kind (Label ((text header)))) (key hdr)
                                    ...
                                    (children No_children))
                                   ((kind (Label ((text row)))) (key row)
                                    (attrs ()) (children No_children)))))))))
                            ((kind
                              (Flow_box
                               ((activate_on_single_click false)
                                (min_children_per_line 1)
                                (max_children_per_line 4) (row_spacing 12)
                                (column_spacing 12) (homogeneous true)
                                (selected (card)))))
                             (attrs
                              ...
                              ((Actions (scope gallery)
                               ...
                               (Shortcut
                                (((trigger
                                   ((key 107)
                                    (modifiers
                                     ((shift false) (control true) (alt false)
                                      (super false) (hyper false) (meta false)))))
                                  (phase Bubble) (action gallery.noop))))))
                             (children
                              (Slots
                               ((popover
                                 (Single
                                  (((kind
                                     (Popover ((open_ false) (position Top))))
                                    ...
                                    (children
                                     (Single
                                      (((kind (Label ((text "menu body"))))
                                        (attrs ()) (children No_children)))))))))))))
                            ((kind
                              (Paned ((orientation Vertical) (position (120)))))
                               ...
                               ((child
                                 (Single
                                  (((kind (Box ((orientation Vertical))))
                                    (attrs
                                     ((Width_request 150) (Height_request 60)))
                                    (children (List ()))))))
                                (overlays
                                 (List
                           ...
                           (((kind (Box ((orientation Vertical))))
                             (attrs
                              ((Focusable true) (Can_focus true) (Test_id keys)
                               (On_key_pressed (phase Bubble)
                                (handler <handler>))
                               (On_key_released (phase Bubble)
                                (handler <handler>))))
                             (children
                              (List
                            ...
                            ((kind (Label ((text focus))))
                             (attrs
                              ((Focusable true) (Test_id focus)
                               (On_focus_enter (phase Bubble)
                                (handler <handler>))
                               (On_focus_leave (phase Bubble)
                                (handler <handler>))
